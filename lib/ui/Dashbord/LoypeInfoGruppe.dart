...
class LoypeInfoGruppe extends StatelessWidget {
  static const String rute = 'loype gruppe info';
  const LoypeInfoGruppe({Key? key}) : super(key: key);
              ...
              IntroductionScreen(
                ...
                pages: [
                  ...
                  PageViewModel(
                    title: 'Gruppespill',
                    body:
                        'Når man spiller gruppespill, må hver enkelt spiller løse oppgavene på sin enhet. Når gruppen finner løsningen til en oppgaven, kan man dele svaret med de andre i gruppen.',
                    decoration: dekorasjon(context),
                    image: Icon(
                      Icons.groups,
                      size: 200,
                  ...
                  PageViewModel(
                    ...
                    body:
                        'Når løypen er fullført kan man frivillig velge å publisere tiden brukt i ledertavlen. \n\nTiden starter når man ankommer første lokasjon. Tiden stopper når den første i gruppen løser alle oppgavene i løypen.',
